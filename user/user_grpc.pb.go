...
const (
	...
	UserService_ReadUser_FullMethodName   = "/UserService/ReadUser"
...
type UserServiceClient interface {
	...
	ReadUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) ReadUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type UserServiceServer interface {
	...
	ReadUser(context.Context, *UserRequest) (*User, error)
...
func (UnimplementedUserServiceServer) ReadUser(context.Context, *UserRequest) (*User, error) {
...
func _UserService_ReadUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ReadUser(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
